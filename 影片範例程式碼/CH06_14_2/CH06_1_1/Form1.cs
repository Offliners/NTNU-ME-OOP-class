        ...
        private void btn_Contest_Click(object sender, EventArgs e)
        {
            ...
            foreach (var animal in aniArr)
            {
                if (animal != null)
                {
                    ...
                    //魔法比賽
                    MachineCat mcat = animal as MachineCat;
                    if (mcat!=null)
                    {
                        txt_MagicContest.AppendText(mcat.ChangeThing() + Environment.NewLine);
                    }
                    MagicCattle mcattle = animal as MagicCattle; //downcasting
                    if (mcattle!=null)
                    {   
                        txt_MagicContest.AppendText(mcattle.ChangeThing() + Environment.NewLine);
                    }
                }
            }
        }
